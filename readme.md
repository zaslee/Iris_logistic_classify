...
建议在jupyter notebook下运行，代码分为([简单demo_two_classification_only.ipynb](https://github.com/zasle/Iris_logistic_classify/blob/master/demo_two_classification_only.ipynb))、([综合demo_all.ipynb](https://github.com/zasle/Iris_logistic_classify/blob/master/demo_all.ipynb) )以及([模型可视化plot_modle.ipynb](https://github.com/zasle/Iris_logistic_classify/blob/master/plot_modle.ipynb) )三个部分.
